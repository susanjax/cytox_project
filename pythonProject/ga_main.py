...
def Genetic_Algorithm(generation_number, population_size): #(population_size):
    ...
    Generation1.to_csv('output/results/lungnew/pop_size_' + str(population_size) + '_Generation_1.csv')
    ...
    Generation2.to_csv('output/results/lungnew/pop_size_' + str(population_size)+ '_Generation_2.csv')
    ...
    while g in range(generation_number + 1):
        ...
        Generation_next.to_csv('output/results/lungnew/pop_size_' + str(population_size) + '_Generation_' + str(g) + '.csv')
    ...
    summary.to_csv('output/results/lungnew/summary_pop_size_' + str(population_size) +'_gen_' + str(generation_number)+'.csv')
...
def final_loop():
    ...
    while gen <=100:
        ...
        et.to_csv('output/results/lungnew/Time_' + str(population_size) + '.csv')
